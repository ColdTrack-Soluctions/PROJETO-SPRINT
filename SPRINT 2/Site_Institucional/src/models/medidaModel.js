...
function buscarMedidasEmTempoReal(idRefrigerador, idEstabelecimento, idCliente) {
    ...
    var instrucaoSql = ` 
    select idDadoTemperatura as 'IdTemp', Temperatura, Horario from 
...
function buscarMedidasEmTempoRealPorta(idporta, idrefrigerador, idestabelecimento, idcliente) {
    ...
    var instrucaoSql = `select idDadoAbertura as 'idAbertura', Aberturas, Horario, fkSensorBloqueio as 'Porta', dadosabertura.fkrefrigerador as 'Refrigerador',
